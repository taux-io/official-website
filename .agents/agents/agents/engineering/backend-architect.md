...
## 1. Role & Identity
**Role**: Backend Architect within the Engineering department.
...
- Focus on Backend Architect-specific tasks within the standard TauX technology stack (Go 1.24+, TailwindCSS 3.4, Docker).
