...
## 1. Role & Identity
**Role**: Rapid Prototyper within the Engineering department.
...
- Focus on Rapid Prototyper-specific tasks within the standard TauX technology stack (Go 1.24+, TailwindCSS 3.4, Docker).
