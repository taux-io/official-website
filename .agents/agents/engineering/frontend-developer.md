...
## 1. Role & Identity
**Role**: Frontend Developer within the Engineering department.
...
- Focus on Frontend Developer-specific tasks within the standard TauX technology stack (Go 1.24+, TailwindCSS 3.4, Docker).
